...
//        new ParallelCommandGroup(commands).schedule();
    ...
    SendableChooser<Command> loadAutonomous() {
        ...
        var fourNoteCompatLeft = new SequentialCommandGroup(
                    ...
                    new ReadyWhileMovingShootCommand(
                            followTrajectory(fourNoteCompatLeftArr[7]),
                            flywheelSubsystem, noteManagementSubsystem, groundIntakeSubsystem, ramFireSpeed, deadline_seconds
                    ),
                    followTrajectory(fourNoteCompatLeftArr[8]),
                    followTrajectory(fourNoteCompatLeftArr[9]),
                    followTrajectory(fourNoteCompatLeftArr[10]),
                    new ReadyWhileMovingGroundIntakeCommand(
                            followTrajectory(fourNoteCompatLeftArr[11]),
                            noteManagementSubsystem, groundIntakeSubsystem
                    ),
                    followTrajectory(fourNoteCompatLeftArr[12]),
                    followTrajectory(fourNoteCompatLeftArr[13]),
                    new ReadyWhileMovingShootCommand(
                            followTrajectory(fourNoteCompatLeftArr[14]),
                            flywheelSubsystem, noteManagementSubsystem, groundIntakeSubsystem, ramFireSpeed, deadline_seconds
                    )
        ...
        var sixNote = new SequentialCommandGroup(
                ...
                followTrajectory(sixNoteArr[9]),
                new ReadyWhileMovingGroundIntakeCommand(
                        followTrajectory(sixNoteArr[10]),
                        noteManagementSubsystem, groundIntakeSubsystem
                ),
                followTrajectory(sixNoteArr[11]),
                new ReadyWhileMovingShootCommand(
                        followTrajectory(sixNoteArr[12]),
                        flywheelSubsystem, noteManagementSubsystem, groundIntakeSubsystem, ramFireSpeed, deadline_seconds
                ),
                followTrajectory(sixNoteArr[13]),
                new ReadyWhileMovingGroundIntakeCommand(
                        followTrajectory(sixNoteArr[14]),
                        noteManagementSubsystem, groundIntakeSubsystem
                ),
                followTrajectory(sixNoteArr[15]),
                new ReadyWhileMovingShootCommand(
                        followTrajectory(sixNoteArr[16]),
                        flywheelSubsystem, noteManagementSubsystem, groundIntakeSubsystem, ramFireSpeed, deadline_seconds
                )
