...
import org.bitbuckets.commands.shooter.pivot.AwaitPivotPositionCommand;
import org.bitbuckets.commands.shooter.pivot.PivotToPositionIndefinite;
...
public class PivotToPositionFireGroup extends ParallelDeadlineGroup {
    public PivotToPositionFireGroup(FlywheelSubsystem flywheelSubsystem, PivotSubsystem pivotSubsystem, NoteManagementSubsystem noteManagementSubsystem, GroundIntakeSubsystem groundIntakeSubsystem, double position, double flywheelSpeed_metersPerSecondOfFlywheel) {
        super(
