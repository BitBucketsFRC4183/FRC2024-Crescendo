...
public interface Field {
    ...
    double Z_STAGE_CENTER_CLEARANCE = 0.71;
    double Z_CHAIN_CENTER_CLEARANCE = 0.72;
    ...
    Translation3d BLUE_STAGE_LEFT = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS * 2d / 3d), (Y_FIELD_METERS / 2d), 0);
    Translation3d BLUE_STAGE_TOP = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS / 3d), (Y_FIELD_METERS / 2d + STAGE_TRIANGLE_BASE_METERS / 2d), 0);
    Translation3d BLUE_STAGE_BOTTOM = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS / 3d), (Y_FIELD_METERS / 2d - STAGE_TRIANGLE_BASE_METERS / 2d), 0);

    Translation3d RED_STAGE_RIGHT = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS * 2d / 3d), (Y_FIELD_METERS / 2d), 0);
    Translation3d RED_STAGE_TOP = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS * 3d), (Y_FIELD_METERS / 2d + STAGE_TRIANGLE_BASE_METERS / 2d), 0);
    Translation3d RED_STAGE_BOTTOM = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS / 3d), (Y_FIELD_METERS / 2d - STAGE_TRIANGLE_BASE_METERS / 2d), 0);

    //stage chains
    Translation3d BLUE_STAGE_CHAIN_MID_UPPER = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS / 6d), (Y_FIELD_METERS / 2d + STAGE_TRIANGLE_BASE_METERS / 4d), Z_CHAIN_CENTER_CLEARANCE);
    Translation3d BLUE_STAGE_CHAIN_MID_LOWER = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS / 6d), (Y_FIELD_METERS / 2d - STAGE_TRIANGLE_BASE_METERS / 4d), Z_CHAIN_CENTER_CLEARANCE);
    Translation3d BLUE_STAGE_CHAIN_MID_RIGHT = new Translation3d((BLUE_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS / 3d), (Y_FIELD_METERS / 2d), Z_CHAIN_CENTER_CLEARANCE);

    Translation3d RED_STAGE_CHAIN_MID_UPPER = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS / 6d), (Y_FIELD_METERS / 2d + STAGE_TRIANGLE_BASE_METERS / 4d), Z_CHAIN_CENTER_CLEARANCE);
    Translation3d RED_STAGE_CHAIN_MID_LOWER = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS + STAGE_TRIANGLE_HEIGHT_METERS / 6d), (Y_FIELD_METERS / 2d - STAGE_TRIANGLE_BASE_METERS / 4d), Z_CHAIN_CENTER_CLEARANCE);
    Translation3d RED_STAGE_CHAIN_MID_LEFT = new Translation3d((X_FIELD_METERS - RED_ALLIANCE_WALL_TO_STAGE_CENTROID_METERS - STAGE_TRIANGLE_HEIGHT_METERS / 3d), (Y_FIELD_METERS / 2d), Z_CHAIN_CENTER_CLEARANCE);
