...
public class FieldConstants {
    ...
    static final double Y_FROM_MIDPOINT_TO_STEREO = 1.45;
    static final double X_FROM_WALL_TO_AMP = 1.93;
    ...
    static final Translation2d BLUE_STEREO = new Translation2d(0, (FIELD_Y_METERS / 2d) + Y_FROM_MIDPOINT_TO_STEREO);
    static final Translation2d RED_STEREO = new Translation2d( FIELD_X_METERS, (FIELD_Y_METERS / 2d) + Y_FROM_MIDPOINT_TO_STEREO);

    static final Translation2d BLUE_AMP = new Translation2d(X_FROM_WALL_TO_AMP, FIELD_Y_METERS);
    static final Translation2d RED_AMP = new Translation2d(FIELD_X_METERS - X_FROM_WALL_TO_AMP, FIELD_Y_METERS);
