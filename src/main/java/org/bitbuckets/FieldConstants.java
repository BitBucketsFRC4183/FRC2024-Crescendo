...
public class FieldConstants {
    ...
    static final Translation2d BLUE_STEREO = new Translation2d((FIELD_WIDTH_METERS / 2d) + MIDWIDTH_TO_STEREO_METERS, 0);
    static final Translation2d RED_STEREO = new Translation2d((FIELD_WIDTH_METERS / 2d) + MIDWIDTH_TO_STEREO_METERS, FIELD_LENGTH_METERS);
