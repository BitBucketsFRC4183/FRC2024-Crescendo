...
/**
 * MicroOpt: shim the RobotBase and cache the results of isSimulation
 */
public abstract class CachingRobotBase implements AutoCloseable {
        ...
        CameraServerShared shared =
                new CameraServerShared() {
                    ...
                    public void reportVideoServer(int id) {
                        HAL.report(FRCNetComm.tResourceType.kResourceType_PCVideoServer, id + 1);
                    }

                    @Override
                    public void reportUsbCamera(int id) {
                        HAL.report(FRCNetComm.tResourceType.kResourceType_UsbCamera, id + 1);
                    }
                    ...
                    public void reportAxisCamera(int id) {
                        HAL.report(FRCNetComm.tResourceType.kResourceType_AxisCamera, id + 1);
                    }

                    @Override
                    public Long getRobotMainThreadId() {
                        return CachingRobotBase.getMainThreadId();
                    }

                    @Override
                    public boolean isRoboRIO() {
                        return !CachingRobotBase.isSimulation();
                    }
                };
                    ...
                    public void reportUsage(MathUsageId id, int count) {
                        switch (id) {
                            case kKinematics_DifferentialDrive:
                                HAL.report(
                                        FRCNetComm.tResourceType.kResourceType_Kinematics,
                                        FRCNetComm.tInstances.kKinematics_DifferentialDrive);
                                break;
                            case kKinematics_MecanumDrive:
                                HAL.report(
                                        FRCNetComm.tResourceType.kResourceType_Kinematics, FRCNetComm.tInstances.kKinematics_MecanumDrive);
                                break;
                            case kKinematics_SwerveDrive:
                                HAL.report(
                                        FRCNetComm.tResourceType.kResourceType_Kinematics, FRCNetComm.tInstances.kKinematics_SwerveDrive);
                                break;
                            case kTrajectory_TrapezoidProfile:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_TrapezoidProfile, count);
                                break;
                            case kFilter_Linear:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_LinearFilter, count);
                                break;
                            case kOdometry_DifferentialDrive:
                                HAL.report(
                                        FRCNetComm.tResourceType.kResourceType_Odometry, FRCNetComm.tInstances.kOdometry_DifferentialDrive);
                                break;
                            case kOdometry_SwerveDrive:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_Odometry, FRCNetComm.tInstances.kOdometry_SwerveDrive);
                                break;
                            case kOdometry_MecanumDrive:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_Odometry, FRCNetComm.tInstances.kOdometry_MecanumDrive);
                                break;
                            case kController_PIDController2:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_PIDController2, count);
                                break;
                            case kController_ProfiledPIDController:
                                HAL.report(FRCNetComm.tResourceType.kResourceType_ProfiledPIDController, count);
                                break;
                            default:
                                break;
                        }
    ...
    static RuntimeType cachedRuntime = null;
    ...
    public static RuntimeType getRuntimeType() {
        if (cachedRuntime == null) {
            cachedRuntime = RuntimeType.getValue(HALUtil.getHALRuntimeType());
        }
    ...
    private static CachingRobotBase m_robotCopy;
    private static boolean m_suppressExitWarning;

    /** Run the robot main loop. */
    private static <T extends CachingRobotBase> void runRobot(Supplier<T> robotSupplier) {
     ...
     */
    public static <T extends CachingRobotBase> void startRobot(Supplier<T> robotSupplier) {
        ...
        HAL.report(
                FRCNetComm.tResourceType.kResourceType_Language, FRCNetComm.tInstances.kLanguage_Java, 0, WPILibVersion.Version);
        ...
        if (HAL.hasMain()) {
            ...
            m_runMutex.lock();
            CachingRobotBase robot = m_robotCopy;
            m_runMutex.unlock();
            if (robot != null) {
